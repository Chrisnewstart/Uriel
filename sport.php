...
<section class="slogan-index">
  <h2 class="police1">Partager votre passion</h2>
</section>

<section class="police2">
  <p class="margin-p disposition-grand-text">Tu souhaites immortaliser une séance de sport avec des performances qui méritent d'être mises en valeur ?<br>Ou peut-être faire partager quelques images de ta discipline sur les réseaux ?<br>Mon appareil photo & moi sommes chargés à bloc pour tenter de te suivre !<br>Plusieurs forfaits sont disponibles afin de répondre à l'attente de n'importe quel sport. <br>N'hésite pas à nous contacter si tu souhaites mettre en lumière ce que tu aimes !
</section>
